...
def test_edit_backend_form_loads(client, temp_backend):
...
def test_edit_backend_form_not_found(client):
...
def test_update_backend_name(client, temp_backend):
...
def test_update_backend_root_dir(client, temp_backend):
...
def test_update_backend_not_found(client):
...
def test_update_backend_invalid_data(client, temp_backend):
...
def test_update_backend_cache_cleared(client, temp_backend):
...
def test_delete_confirmation_page(client, temp_backend):
...
def test_delete_confirmation_shows_dataset_count(client, temp_backend):
...
def test_delete_backend_success(client, temp_backend):
...
def test_delete_backend_with_datasets(client, temp_backend):
...
def test_delete_backend_not_found(client):
...
def test_delete_backend_cache_cleared(client, temp_backend):
...
def test_delete_backend_redirects_to_list(client, temp_backend):
...
def test_backends_page_shows_edit_delete_buttons(client, temp_backend):
...
def test_edit_button_links_to_edit_form(client, temp_backend):
...
def test_delete_button_links_to_confirmation(client, temp_backend):
...
def test_complete_edit_workflow(client):
...
def test_complete_delete_workflow(client):
...
def test_backend_id_regeneration_on_name_change(client):
...
def test_s3_backend_update(client):
...
def test_error_handling_invalid_backend_id(client):
